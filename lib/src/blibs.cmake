...
option( BGFX_BUILD_EXAMPLES_COMMON      "Build the examples common as a standalone"     ON  )
...
include( ${CMAKE_CURRENT_SOURCE_DIR}/cmake_blibs/version.cmake )

include( ${CMAKE_CURRENT_SOURCE_DIR}/cmake_blibs/shared.cmake )
include( ${CMAKE_CURRENT_SOURCE_DIR}/cmake_blibs/bx.cmake )
include( ${CMAKE_CURRENT_SOURCE_DIR}/cmake_blibs/bimg.cmake )
include( ${CMAKE_CURRENT_SOURCE_DIR}/cmake_blibs/bgfx.cmake )

if( BGFX_BUILD_TOOLS )
	include( ${CMAKE_CURRENT_SOURCE_DIR}/cmake_blibs/tools.cmake )
endif()

if( BGFX_BUILD_TOOLS OR BGFX_BUILD_EXAMPLES )
	include( ${CMAKE_CURRENT_SOURCE_DIR}/cmake_blibs/examples.cmake )
endif()
...
if( BGFX_INSTALL )
	...
	#   * <prefix>/lib*/
	#   * <prefix>/include/
	set(config_install_dir "${CMAKE_INSTALL_LIBDIR}/cmake_blibs/${PROJECT_NAME}")
	...
	configure_package_config_file(
		"${CMAKE_CURRENT_SOURCE_DIR}/cmake_blibs/Config.cmake.in"
		"${project_config}"
